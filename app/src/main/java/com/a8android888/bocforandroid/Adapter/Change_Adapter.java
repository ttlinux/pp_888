...
import com.a8android888.bocforandroid.activity.user.Change.ChangeintoActivity;
...
//        holder.change_balance.getPaint().setFlags(Paint.UNDERLINE_TEXT_FLAG);
    ...
    private  void GetPlatform(String flat,final int indexd) {
        ...
        requestParams.put("userName", ((BaseApplication) mContext.getApplicationContext()).getBaseapplicationUsername());
