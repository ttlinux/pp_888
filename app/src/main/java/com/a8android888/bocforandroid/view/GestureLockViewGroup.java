...
import com.a8android888.bocforandroid.view.GestureLockView.Mode;
...
public class GestureLockViewGroup extends RelativeLayout {
     ...
     */
    private int mFingerOnColor[] = {0xffb2def9,0xFF0095d4};
    /**
     * GestureLockView手指抬起的状态下内圆和外圆的颜色
     */
    private int mFingerUpColor[] = {0xffb2def9,0xFF0095d4};
...
//                }
     ...
     * 少于limitsize 就重置 不算
     */
    public void setLimitListener(int size,onLimitListener onLimitListener)
    {
        limitsize=size;
