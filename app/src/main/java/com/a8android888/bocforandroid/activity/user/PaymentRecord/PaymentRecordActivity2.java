...
import com.a8android888.bocforandroid.Adapter.PaymentAdapter2;
 ...
 */
public class PaymentRecordActivity2 extends BaseActivity implements View.OnClickListener{
    ...
    ArrayList<PaymentBean2> payments=new ArrayList<PaymentBean2>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText(getString(R.string.payoutrecord));
        ...
        choosetype.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                WheelDialog2 dialog = new WheelDialog2(PaymentRecordActivity2.this);
...
//        params.put("endTime", enddate);//YYYY-MM-DD 2016-10-10
        ...
        Httputils.PostWithBaseUrl(Httputils.WithdrawHistory, params, new MyJsonHttpResponseHandler(this, false) {
            ...
            public void onSuccessOfMe(JSONObject jsonObject) {
                ...
                if(jsonArray==null || jsonArray.length()==0){
                    ...
                    SetAdapter();
                    if(page>1)
                    ToastUtil.showMessage(PaymentRecordActivity2.this, getString(R.string.nomoredata));
                    return;
                }
...
//            }
    ...
    public void SetAdapter()
    {
        if (paymentAdapter == null) {
            paymentAdapter = new PaymentAdapter2(PaymentRecordActivity2.this, payments);
