...
import com.a8android888.bocforandroid.util.MyJsonHttpResponseHandler2;
...
//跳转电子网页时取的数据
    ...
    public static void GetData(Context context,final String flat,final String gameCode,final String title,final String pull) {
        ...
        requestParams.put("userName", ((BaseApplication) context.getApplicationContext()).getBaseapplicationUsername());
        requestParams.put("flat", flat);


        Httputils.PostWithBaseUrl(Httputils.gameloginlist, requestParams, new MyJsonHttpResponseHandler(activity, true) {
            @Override
