...
/**
 * Created by Administrator on 2017/4/5. 第9名
 */
public class D9MFragment extends BaseFragment implements View.OnClickListener {
...
//                    }
                    ...
                    if (adapter == null) {
                        adapter = new Lottery_pkfragment_Adapter(D9MFragment.this.getActivity(), basefragments, "normal");
