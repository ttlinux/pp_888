...
/**
 * Created by Administrator on 2017/4/5. 第10名
 */
public class D10MFragment extends BaseFragment implements View.OnClickListener {
...
//                    }
                    ...
                    if (adapter == null) {
                        adapter = new Lottery_pkfragment_Adapter(D10MFragment.this.getActivity(), basefragments, "normal");
