...
/**
 * Created by Administrator on 2017/4/5. 第7名
 */
public class D7MFragment extends BaseFragment implements View.OnClickListener {
...
//                    }
                    ...
                    if (adapter == null) {
                        adapter = new Lottery_pkfragment_Adapter(D7MFragment.this.getActivity(), basefragments, "normal");
