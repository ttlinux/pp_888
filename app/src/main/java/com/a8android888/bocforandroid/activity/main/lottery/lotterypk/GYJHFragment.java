...
/**
 * Created by Administrator on 2017/4/5. 冠军亚和
 */
public class GYJHFragment extends BaseFragment implements View.OnClickListener {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        if (LotteryFragment1.getGanmeitmexzlxcode().length() < 1) {
                            if (jsond.optString("id").indexOf("GYJH") != -1) {
...
//                    }
                    ...
                    if (adapter == null) {
                        adapter = new Lottery_pkfragment_Adapter(GYJHFragment.this.getActivity(), basefragments, "normal");
