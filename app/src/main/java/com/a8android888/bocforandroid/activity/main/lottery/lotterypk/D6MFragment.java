...
/**
 * Created by Administrator on 2017/4/5. 第6名
 */
public class D6MFragment extends BaseFragment implements View.OnClickListener {
...
//                    }
                    ...
                    if (adapter == null) {
                        adapter = new Lottery_pkfragment_Adapter(D6MFragment.this.getActivity(), basefragments, "normal");
