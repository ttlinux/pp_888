...
/**
 * Created by Administrator on 2017/3/31.棋牌游戏
 */
...
private ImageView back;
    ...
    private void initview() {
        ...
        title.setText(this.getResources().getText(R.string.cardtitle));
...
//                try {
//                    JSONArray jsonArray = json.getJSONArray("card");
...
//                    }
                try {
                    ...
                    for (int i = 0; i <jsonArray.length() ; i++) {
                        ...
                        if( jsonda.optString("menuCode", "").equalsIgnoreCase("card")) {
                ...
                adapter = new Real_Video_Adapter(CardActivity.this, gameBeanList,gameStringList,gameflatList,"4");
                gridView.setAdapter(adapter);
