...
/**
 * Created by Administrator on 2017/4/24.//定位
 */
public class DWFragment extends BaseFragment implements View.OnClickListener{
    ...
    private void GetData()
    {
        ...
        Httputils.PostWithBaseUrl(Httputils.refreshRate, params, new MyJsonHttpResponseHandler(getActivity(), Lottery_MainActivity.needdialog()) {
            ...
            public void onSuccessOfMe(JSONObject jsonObject) {
                ...
                int index = 0;
                if (LotteryFragment1.getGanmeitmexzlxcode().equalsIgnoreCase("BDW") || LotteryFragment1.getGanmeitmexzlxcode().equalsIgnoreCase("SDW")
                        || LotteryFragment1.getGanmeitmexzlxcode().equalsIgnoreCase("GDW")) {
