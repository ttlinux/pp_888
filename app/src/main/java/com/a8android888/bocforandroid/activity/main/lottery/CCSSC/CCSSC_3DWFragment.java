...
/**
 * Created by Administrator on 2017/4/24.//3字定位
 */
public class CCSSC_3DWFragment extends BaseFragment implements View.OnClickListener{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        titles=CCSSC_3DWFragment.this.getResources().getStringArray(R.array.ccssc_dingwei);
    ...
    public void StartActvity(ArrayList<LotterycomitorderBean> beans) {
        if (beans.size() > 0) {
            ...
            if(index==3){
                ...
                ToastUtil.showMessage(this.getActivity(), "只能选择3行");
            }
        } else {
            ToastUtil.showMessage(this.getActivity(), "只能选择3行");
        }
