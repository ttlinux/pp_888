 ...
 */
public class CCSSC_1ZHFragment extends BaseFragment implements View.OnClickListener{
    ...
    {
        titles = new String[]{LotteryFragment1.getGanmeitmexzlxname()+"一字组合"};
        ...
        if(twoListAdapter==null)
        {
            ...
            twoListAdapter.NotifyAdapter(sparseArray,new String[]{LotteryFragment1.getGanmeitmexzlxname()+"一字组合"});
