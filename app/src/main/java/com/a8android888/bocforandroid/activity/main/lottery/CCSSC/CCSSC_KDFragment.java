...
/**
 * Created by Administrator on 2017/4/24.跨度
 */
public class CCSSC_KDFragment extends BaseFragment implements View.OnClickListener{
        ...
        Httputils.PostWithBaseUrl(Httputils.refreshRate, params, new MyJsonHttpResponseHandler(getActivity(), Lottery_MainActivity.needdialog()) {
            ...
            public void onSuccessOfMe(JSONObject jsonObject) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    int iii=0;
                    if (id.indexOf("KD-QSW-") != -1)
                        iii=0;
                    if (id.indexOf("KD-ZSW-") != -1)
                        iii=1;
                    if (id.indexOf("KD-HSW-") != -1)
                        iii=2;
                    if (result < 0) {
                        keys.add(id);
    ...
    {
        titles=CCSSC_KDFragment.this.getResources().getStringArray(R.array.ccssc_kuadu);
        ...
        if(twoListAdapter==null)
        {
            ...
            twoListAdapter.NotifyAdapter(sparseArray,CCSSC_KDFragment.this.getResources().getStringArray(R.array.ccssc_kuadu));
