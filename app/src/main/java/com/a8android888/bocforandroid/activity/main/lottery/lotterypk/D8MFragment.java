...
/**
 * Created by Administrator on 2017/4/5. 第8名
 */
public class D8MFragment extends BaseFragment implements View.OnClickListener {
...
//                    }
                    ...
                    if (adapter == null) {
                        adapter = new Lottery_pkfragment_Adapter(D8MFragment.this.getActivity(), basefragments, "normal");
