...
/**
 * Created by Administrator on 2017/4/5. 第5名
 */
public class D5MFragment extends BaseFragment implements View.OnClickListener {
...
//                    }
                    ...
                    if (adapter == null) {
                        adapter = new Lottery_pkfragment_Adapter(D5MFragment.this.getActivity(), basefragments, "normal");
