...
/**
 * Created by Administrator on 2017/4/5. 第4名
 */
public class D4MFragment extends BaseFragment implements View.OnClickListener {
...
//                JSONObject json = jsonObject.optJSONObject("datas");
                ...
                try {
                    ...
                    if(jsonArray==null || jsonArray.length()<1)return;
...
//                    }
                    ...
                    if (adapter == null) {
                        adapter = new Lottery_pkfragment_Adapter(D4MFragment.this.getActivity(), basefragments, "normal");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.comit:
                ...
                if(adapter!=null)
                {
                    LogTools.e("adapter.getSelectedData",new Gson().toJson(adapter.getSelectedData()));
                    StartActivity(adapter.getSelectedData());
                }
                break;
        }
    }
