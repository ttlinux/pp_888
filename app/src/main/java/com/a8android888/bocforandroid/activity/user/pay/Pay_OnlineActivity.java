...
import com.a8android888.bocforandroid.view.MyWebViewforPay;
...
public class Pay_OnlineActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initview() {
        ...
        title.setText(data.optString("payName", ""));
    ...
    private void fastPay()//个人快捷支付
    {
        ...
        params.put("money", Httputils.Limit2(money * 1.00d));//Httputils.Limit2(money * 1.00d)
