...
/**
 * Created by Administrator on 2017/4/24.数字盘
 */
public class CCSSC_SZPFragment extends BaseFragment implements View.OnClickListener{
        ...
        Httputils.PostWithBaseUrl(Httputils.refreshRate, params, new MyJsonHttpResponseHandler(getActivity(), Lottery_MainActivity.needdialog()) {
            ...
            public void onSuccessOfMe(JSONObject jsonObject) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    int iii=0;
                    if (id.indexOf("SZP-WW-") != -1)
                        iii=0;
                    if (id.indexOf("SZP-QW-") != -1)
                        iii=1;
                    if (id.indexOf("SZP-BW-") != -1)
                        iii=2;
                    if (id.indexOf("SZP-SW-") != -1)
                        iii=3;
                    if (id.indexOf("SZP-GW-") != -1)
                        iii=4;
                    if (result < 0) {
                        keys.add(id);
    ...
    {
        titles=getResources().getStringArray(R.array.ccssc_shuzipan);
        ...
        if(twoListAdapter==null)
        {
            ...
            twoListAdapter.NotifyAdapter(sparseArray,getResources().getStringArray(R.array.ccssc_shuzipan));
