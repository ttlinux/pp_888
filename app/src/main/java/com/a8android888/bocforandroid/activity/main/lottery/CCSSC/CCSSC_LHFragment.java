...
import com.a8android888.bocforandroid.Adapter.LHTwoListAdapter;
...
/**
 * Created by Administrator on 2017/4/24.龙虎
 */
public class CCSSC_LHFragment extends BaseFragment implements View.OnClickListener{

    public SparseArray<ArrayList<LotterycomitorderBean>> sparseArray;
    private LHTwoListAdapter LHTwoListAdapter;
    ListView lsitview2;
    String[] titles;
    ...
    public void OnViewShowOrHide(boolean state) {
        ...
        else
        {
            ...
            {
                ThreadTimer.Stop(getClass().getName());
                if(LHTwoListAdapter!=null )
                    if(LHTwoListAdapter!=null ){
                        LHTwoListAdapter.ClearRecordData();
                        LHTwoListAdapter.NotifyAdapter(null);
                    }
            ...
            public void onSuccessOfMe(JSONObject jsonObject) {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    if (result < 0) {
                        ...
                        sparseArray.put(i, jsonjects);
                        sparseArray.get(i).add(gameBean1);
                    } else {
    ...
    public void SetAdapter()
    {
        ...
        if(LHTwoListAdapter==null)
        {
            LHTwoListAdapter=new LHTwoListAdapter(getActivity(),sparseArray,titles);
            lsitview2.setAdapter(LHTwoListAdapter);
        }
        else
            LHTwoListAdapter.NotifyAdapter(sparseArray);
    ...
    public void onClick(View v) {
        switch (v.getId())
        {
            case R.id.comit:
                ...
                if(LHTwoListAdapter!=null) {
                    StartActivity(LHTwoListAdapter.GetSelectItem());
                }
                break;
            case R.id.reset:
                if(LHTwoListAdapter!=null){
                    LHTwoListAdapter.ResetState();
                }
                break;
        }
    }
