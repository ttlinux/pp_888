...
import com.a8android888.bocforandroid.Bean.ContactArray;
import com.a8android888.bocforandroid.MainActivity;
import com.a8android888.bocforandroid.MainActivity2;
import com.a8android888.bocforandroid.Manifest;
import com.a8android888.bocforandroid.R;
import com.a8android888.bocforandroid.activity.main.JumpActivity;
import com.a8android888.bocforandroid.model.Maindata;
...
import com.a8android888.bocforandroid.util.UpdateManager;
import com.a8android888.bocforandroid.util.WifiMethod;
...
//	String time;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setBackground(BaseApplication.getQidong());
...
//			new Thread(mphone).start();
                    ...
                    imageView1.setBackground(BaseApplication.getQidong());
                    ...
                    mImageDownLoader = ((BaseApplication) WelcomeActivity.this.getApplication())
                            .getImageLoader();
...
//                    startThread.start();
            ...
            public void onSuccessOfMe(JSONObject jsonObject) {
                ...
                if (jsonObject.optString("errorCode", "").equalsIgnoreCase("000000")) {
                    SharedPreferences sharedPreferences = ((BaseApplication) WelcomeActivity.this.getApplication()).getSharedPreferences();
    ...
    private void Start(final long time) {
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                Boolean isc = ((BaseApplication) getApplication()).isNetConnect();
                ...
                public void run() {
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            super.run();
                            try {
                                URL url = new URL(Httputils.GetApkDownloadPath());
