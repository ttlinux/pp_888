...
/**
 * Created by Administrator on 2017/4/24.二字定位
 */
public class CCSSC_2DWFragment extends BaseFragment implements View.OnClickListener{
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        titles=CCSSC_2DWFragment.this.getResources().getStringArray(R.array.ccssc_dingwei);
    }
...
//            }
       if(index==2){
           ...
           LogTools.e("this.getActivity()33333","this.getActivity()3333");
                ToastUtil.showMessage(this.getActivity(), "有且仅选择2行");
            }
        } else {
            LogTools.e("this.getActivity()222222","this.getActivity()222222");
            ToastUtil.showMessage(this.getActivity(), "至少选择一项");
        }
    }
